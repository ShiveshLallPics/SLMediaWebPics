document.addEventListener('DOMContentLoaded', () => {
    ...
    const images = [
        ...
        { src: 'https://lh3.googleusercontent.com/d/1aySHSmcBZaM-OYY31l1sXBqZ6iSwSdyg', type: 'engagement' },
        { src: 'https://lh3.googleusercontent.com/d/1w1LDOOKeknrHwt_xTBMpc959w-pfEHG0', type: 'engagement' },
        { src: 'https://lh3.googleusercontent.com/d/17flbk1pjWlFb1Nd0k8uyfpaMmG3bgShG', type: 'engagement' },
        { src: 'https://lh3.googleusercontent.com/d/1h--whfc4n8i4bpHszpVPTv_Wlv3EG2o5', type: 'engagement' },
        { src: 'https://lh3.googleusercontent.com/d/1pWjPYxRWxnJISrDD02b6ZFTnKL8uX_Ie', type: 'engagement' },
        { src: 'https://lh3.googleusercontent.com/d/197vWriYNNfzNjRks27Ees2BykEge5I1c', type: 'engagement' },
        { src: 'https://lh3.googleusercontent.com/d/1AIKGLEwslmRGdJEmWWkfnhpkUdNKRnkE', type: 'engagement' },
        ...
        { src: 'https://lh3.googleusercontent.com/d/1uDelKivt505z404A_RQVyhsHxh06-MF_', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1Uvb_tzk0q54q2KkDUSQtFlebA7pCsHZS', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1t_UXUwCT5y3o3pDab47iK1UtZA808CbT', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/10y2_TKT4bbelJotrttQ2yClUCJ1ooXwy', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1-HtQB_4wTRXKGjRfifLoUscSw_2_S-xZ', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1-Rh_PMA5eI0iyskLH0W3m_lXQb_f31FP', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1-K_GtR2JOLldX46mRpddXeMITr1o2uAa', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1-GM8gvl2QQVD9aZMVrbfkvi0ZDPoecU4', type: 'landscape', alt: 'Mountain landscape' },
        { src: 'https://lh3.googleusercontent.com/d/1-ctnIogYkNaathKRFiVjlFlZvJ9JslF2', type: 'landscape', alt: 'Mountain landscape' },
        ...
        { src: 'https://lh3.googleusercontent.com/d/16rRVih8bvyt91nGEtMDsvvlmWTVUEnIV', type: 'portrait', alt: 'Conference hall' },
        { src: 'https://lh3.googleusercontent.com/d/1Ad6L7xSOoJAXrXBCotPVry52QiJJoWQ5', type: 'portrait', alt: 'Conference hall' },
        { src: 'https://lh3.googleusercontent.com/d/1YlZOVWqbnHrcgTCkitFTx8M2I2dl2FNl', type: 'portrait', alt: 'Conference hall' },
        { src: 'https://lh3.googleusercontent.com/d/1MP4c49xXUrO4Em6_6EB-wocK6Tqy_F-f', type: 'portrait', alt: 'Conference hall' },
        { src: 'https://lh3.googleusercontent.com/d/1pQzVTa7Ezc4W9SN7DwBKLctuAHWJeq3t', type: 'portrait', alt: 'Conference hall' },
        ...
        { src: 'https://lh3.googleusercontent.com/d/1MKQ5J5T5__Npb_P5rWi_b9VlBli90BqC', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/10QkgEgxK5eXhp-wTmzAldwlRMH10nUAZ', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/1GeMrOuRYt5vU4ad9AyVloVnxJp5LOZJn', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/1lvb2Ad-PYU_Yk4_zmdvMyy99mnoFGR2q', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/1ZuI_Q-6yUQwjI7yWBOkH-LCdXiQkMN6W', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/1Hsa9j6CW0ny71RV0c89WnIwLklqNsFFi', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/1LDU7XgJwVijWzr6Lswh5M5MjmFzEwpL5', type: 'automotive', alt: 'Luxury car' },
        { src: 'https://lh3.googleusercontent.com/d/1K0ZRy94wLx7mvxAQSfd02WpbLI9g_Woq', type: 'automotive', alt: 'Luxury car' },
        ...
        { src: 'https://lh3.googleusercontent.com/d/1exDRJYSxNgNnf45Rv-k2FLi7QKzlqTjn', type: 'food', alt: 'Close-up of food' },
        { src: 'https://lh3.googleusercontent.com/d/1f5_oYp8zreh9gESBzMTY6PQjQJedtOO9', type: 'food', alt: 'Close-up of food' },
        { src: 'https://lh3.googleusercontent.com/d/1C_QUl5iK0WV2Q5a3ti-AYMUTouwRtLLt', type: 'food', alt: 'Close-up of food' },
